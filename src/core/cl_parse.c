...
void CL_ParseClientdata (int bits)
{
	...
	// Metal Quake: trigger per-weapon haptic on weapon fire (punchangle != 0)
	if (cl.punchangle[0] || cl.punchangle[1] || cl.punchangle[2])
	{
		extern void IN_PlayWeaponHaptic(int weaponId);
		IN_PlayWeaponHaptic(cl.stats[STAT_ACTIVEWEAPON]);
	}
